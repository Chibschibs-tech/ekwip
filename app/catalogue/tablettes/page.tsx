...
export default async function TablettesPage() {
  ...
  const category = categories.find((cat) => cat.slug === "tablettes")

  // If category not found, use default values
  const categoryId = category?.id || 4
  const categoryName = category?.name || "Tablettes"
  const categoryDescription = category?.description || "Tablettes tactiles pour une productivité en déplacement"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Optimisation des coûts</h3>
              <p className="text-slate-600">
                Réduisez vos investissements initiaux et transformez vos dépenses d'équipement en coûts opérationnels
                prévisibles.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Équipement toujours à jour</h3>
              <p className="text-slate-600">
                Bénéficiez des dernières technologies sans vous soucier de l'obsolescence de vos équipements.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Support et maintenance inclus</h3>
              <p className="text-slate-600">
                Profitez d'un service complet incluant la maintenance, le support technique et le remplacement en cas de
                panne.
              </p>
            </div>
          </div>
