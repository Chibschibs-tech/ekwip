...
export default async function MobilierPage() {
  ...
  const category = categories.find((cat) => cat.slug === "mobilier")

  // If category not found, use default values
  const categoryId = category?.id || 7
  const categoryName = category?.name || "Mobilier"
  const categoryDescription = category?.description || "Mobilier de bureau ergonomique et fonctionnel"
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold text-slate-800">Notre {categoryName.toLowerCase()}</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
              Pourquoi louer votre {categoryName.toLowerCase()} ?
            </h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Découvrez les avantages de la location de {categoryName.toLowerCase()} pour votre entreprise.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Flexibilité d'aménagement</h3>
              <p className="text-slate-600">
                Adaptez votre espace de travail selon vos besoins évolutifs sans investissement initial important.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Mobilier ergonomique</h3>
              <p className="text-slate-600">
                Bénéficiez de mobilier ergonomique de qualité pour améliorer le confort et la productivité de vos
                équipes.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Installation et maintenance</h3>
              <p className="text-slate-600">
                Profitez d'un service complet incluant l'installation, la maintenance et le remplacement si nécessaire.
              </p>
            </div>
          </div>
        </div>
