...
export default async function ImprimantesPage() {
  ...
  const category = categories.find((cat) => cat.slug === "imprimantes")

  // If category not found, use default values
  const categoryId = category?.id || 6
  const categoryName = category?.name || "Imprimantes"
  const categoryDescription = category?.description || "Solutions d'impression pour tous vos besoins professionnels"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Maintenance incluse</h3>
              <p className="text-slate-600">
                Bénéficiez d'une maintenance complète incluant les consommables et les réparations.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Technologies récentes</h3>
              <p className="text-slate-600">
                Accédez aux dernières technologies d'impression sans investissement initial important.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Support technique 24/7</h3>
              <p className="text-slate-600">
                Profitez d'un support technique disponible 24h/24 et 7j/7 pour tous vos besoins d'impression.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">
            Besoin d'une solution d'impression personnalisée ?
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-8">
            Contactez-nous pour discuter de vos besoins spécifiques en impression. Nous pouvons vous proposer des
