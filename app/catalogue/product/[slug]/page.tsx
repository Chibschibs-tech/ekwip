...
import { ArrowLeft, ShoppingCart, Heart, Share2, Check, Truck, Shield, Headphones } from "lucide-react"
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-[#1f3b57]">
                      {formatPrice(product.price)}<span className="text-lg font-normal">/mois</span>
                    </p>
                  </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-lg font-bold text-[#1f3b57]">
                          {formatPrice(relatedProduct.price)}<span className="text-sm font-normal">/mois</span>
                        </p>
