      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <div className="h-16 w-16 bg-[#1f3b57] rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl">
                1
              </div>
              ...
              <Button className="mt-8 bg-[#1f3b57] hover:bg-[#1a3249]">Voir le catalogue</Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
            <div>
              ...
              <Button className="mt-8 bg-[#1f3b57] hover:bg-[#1a3249]">Demander un devis</Button>
            </div>
            <div className="bg-slate-100 rounded-xl p-8 h-80 flex items-center justify-center">
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-[#1f3b57] hover:bg-[#1a3249] px-8 py-6 text-lg">Demander un devis</Button>
