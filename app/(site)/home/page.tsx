...
const categories = [
  {
    ...
    description: "Des laptops performants pour tous vos besoins professionnels",
    slug: "ordinateurs-portables",
  },
  {
    iconName: "desktop",
    title: "Ordinateurs de bureau",
    description: "Stations de travail puissantes pour votre entreprise",
    slug: "ordinateurs-bureau",
  },
  {
    iconName: "smartphone",
    title: "Smartphones",
    description: "Les derniers modèles pour rester connecté",
    slug: "smartphones",
  },
  {
    iconName: "printer",
