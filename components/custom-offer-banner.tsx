  ...
  return (
    <section className="py-20 px-4 md:px-6 lg:px-8 bg-gradient-to-r from-ekwip to-ekwip-700 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-ekwip-100 mb-8 max-w-2xl mx-auto">
          Découvrez nos solutions de location IT avec une remise exceptionnelle sur votre premier mois de location.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/catalogue">
            <Button size="lg" className="bg-white text-ekwip hover:bg-ekwip-50">
              Profiter de l'offre
            </Button>
          </Link>
          <Link href="/contact">
        ...
        <p className="text-sm text-ekwip-200 mt-6 flex items-center justify-center">
